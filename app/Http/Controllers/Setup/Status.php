...
class Status extends Controller
{
    ...
    private $SubFolder = "/status"; //Sub Folder Name inside the resources/views/$ThemePath/pages/$MainFolder/
    private $Upload = ""; //Upload Folder Name inside the public/admin/media

    private $Access = "shipment-status"; // Access level for this controller
    private $ParentRoute = "setup-status"; // Parent Route Name Eg. vrm-settings
    ...
    private $New = 'setup-status/add'; // New
    private $Save = 'setup-status/save'; // Add New
    private $Edit = 'setup-status/edit'; // Edit
    private $Update = 'setup-status/update'; // Update
    private $Delete = 'setup-status/delete'; // Delete
    ...
    public function index($message = '')
    {
        ...
        // Shipment Status
        $data['shipment_list'] = Hierarchy::where('type', 'shipment_status')->latest()->get();
    ...
    public function store(Request $request, $action = '')
    {
        ...
        $insertFrom['type'] = 'shipment_status';
        $insertFrom['parent'] = 0;
        $insertFrom['flag'] = 1;
        ...
        if ($saved) {
            ...
            // Open Page
            return $this->index('<strong>Error:</strong> Status creationg was successful.');
        } else {
            // Notification
            session()->flash('notification', 'error');
