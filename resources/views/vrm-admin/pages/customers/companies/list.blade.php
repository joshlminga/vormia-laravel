                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="customer" class="form-label sks-required"> Choose Customer </label>
                                    <select name="customer"
                                        ...
                                        @foreach ($customer_list as $index => $list)
                                            <option value="{{ $list->id }}" @selected(old('customer') == $list->id)>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('city') is-invalid @enderror"
                                        id="" placeholder="" name="city" value="{{ old('city') }}">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('country') is-invalid @enderror"
                                        id="" placeholder="" name="country" value="{{ old('country') }}">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach ($entry_list as $list)
                                <tr>
                                    <td>{{ $list->id }}</td>
                                    <td>{{ $list->customerinfo->name }} - {{ $list->customerinfo->phone }}</td>
                                    <td>{{ $list->name }}</td>
                                    <td>
                                        @if ($list->flag == 1)
